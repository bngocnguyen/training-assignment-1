<template>
    <div v-if="thisArticle" id="wrapper">
                        ...
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                ...
                                <div class="blog-meta big-meta">
                                    <small><a href="marketing-single.html" title="">{{ thisArticle.publishedAt }}</a></small>
                                    <small><a href="blog-author.html" title="">{{ thisArticle.kasaix }}</a></small>
...
import { mapState, mapActions, mapGetters } from 'vuex';
    export default {
        computed: {
            ...mapState(['articles']),
            ...mapGetters(['getArticleBySlug']),
            thisArticle() {
                return this.$store.getters.getArticleBySlug(this.$route.params.single);
            }
        },
        methods:  {
